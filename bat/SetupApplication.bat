...
:: Android packaging
set AND_CERT_NAME="OneMoreShooter"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\OneMoreShooter.p12
...
set IOS_PROVISION=cert\OneMoreShooter.mobileprovision
...
set APP_ID=air.OneMoreShooter

:: Output packages
set DIST_PATH=dist
set DIST_NAME=OneMoreShooter
